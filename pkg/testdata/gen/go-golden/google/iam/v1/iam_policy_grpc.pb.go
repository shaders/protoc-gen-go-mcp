...
func (c *iAMPolicyClient) SetIamPolicy(ctx context.Context, in *SetIamPolicyRequest, opts ...grpc.CallOption) (*Policy, error) {
	...
	out := new(Policy)
	err := c.cc.Invoke(ctx, IAMPolicy_SetIamPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMPolicyClient) GetIamPolicy(ctx context.Context, in *GetIamPolicyRequest, opts ...grpc.CallOption) (*Policy, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Policy)
	err := c.cc.Invoke(ctx, IAMPolicy_GetIamPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMPolicyClient) TestIamPermissions(ctx context.Context, in *TestIamPermissionsRequest, opts ...grpc.CallOption) (*TestIamPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMPolicy_TestIamPermissions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedIAMPolicyServer must be embedded to have
...
func (UnimplementedIAMPolicyServer) testEmbeddedByValue()                   {}
...
func RegisterIAMPolicyServer(s grpc.ServiceRegistrar, srv IAMPolicyServer) {
	// If the following call pancis, it indicates UnimplementedIAMPolicyServer was
